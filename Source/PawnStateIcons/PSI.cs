    ...
    class PSI : MonoBehaviour
    {
        ...
        public void updateColonistStats(Pawn colonist)
        {
            ...
            if (colonist.jobs.curJob != null)
            {
                ...
                {
                    if (colonist.carrier != null && colonist.carrier.CarriedThing != null)
                        tp = curJob.targetB;
                }
        ...
        public void updateOptionsDialog() {
                    Dialog_Options optionsDialog = Find.WindowStack.WindowOfType<Dialog_Options>();
                    bool optionsOpened = optionsDialog != null;
                    bool psiSettingsShowed = Find.WindowStack.IsOpen(typeof(Dialog_IconModSettings));
        ...
        public void drawColonistIcons(Pawn colonist) {
                    ...
                    if (colonist.drafter == null) return;
