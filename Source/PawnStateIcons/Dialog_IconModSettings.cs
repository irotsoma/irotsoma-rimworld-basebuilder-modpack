...
{
    class Dialog_IconModSettings : Window
    {

        public string page = "main";
        
        
        public Window optionsDialog = null;
    ...
    protected void fillPageArrangement(Listing_Standard listing)
    {
        ...
        public override void DoWindowContents(UnityEngine.Rect inRect)
        {
            ...
            Rect optionsRect = optionsDialog.currentWindowRect;
            this.currentWindowRect = new Rect(optionsRect.xMax - 240, optionsRect.yMin, 240, optionsRect.height);
            Listing_Standard listing = new Listing_Standard(inRect);

            DoHeading(listing, "Pawn State Icons", false);

            listing.OverrideColumnWidth = this.currentWindowRect.width;
